...
public class TicketDto {
    ...
    public TicketDto(String cityname, double price, double winamount, Long quantity, Long startquantity, LocalDateTime startDateTime,
                     LocalDateTime endDateTime, String description, String winner, Long winnerticket) {
        super();
